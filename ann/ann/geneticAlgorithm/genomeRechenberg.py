...
class Genome(AbstractClassGenome):
    ...
    def print_genome(self):
        ...
        logging.info('Genome: Alpha: {.2f}'.format(self.alpha))
    ...
    def print_genome_ma(self):
        ...
        """
        self.print_geneparam()
        logging.info('Genome: Generation: {:d} UniID: {:d} Elter: {:d} Mutability: {:.2f}  Alpha: {:.2f} Accuracy: {.5e} Hash: {:s}'.format(self.generation, self.u_ID, self.elter_ID, self.mutability, self.alpha, self.accuracy, self.hash))
